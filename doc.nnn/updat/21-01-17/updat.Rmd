...
Two weeks ago, it appeared that cases in Washington state cases had hit their peak and were heading down, but the past two week's data (Figure 1a) belie that hopeful conclusion: after a small dip, cases are increasing again everywhere except Snohomish (north of Seattle). The dip may reflect reporting lags over the holidays or operational issues caused by changes in [Washington DOH](#doh) reporting procedures [described previously](https://natgoodman.github.io/covid/doc.nnn/updat/21-01-10/updat.html#caveats). In non-Washington locations (Figure 1b), cases continue to increase everywhere except Ann Arbor. The decline in Ann Arbor has persisted for several weeks and is possibly due to the University of Michigan ending on-site teaching for most students. Two weeks ago, it seemed Boston and DC might be reaching their peaks, but the past two week's data shows a continuing climb, with a glimmer that the rate of increase may be slowing.

Figures 2a-b show *deaths* per million for the same locations. When comparing Figures 2a and 2b, please note the difference in y-scale: the current Washington rates (20-35 per million) are similar to but slightly lower than the non-Washington rates.
...
The Washington data (Figure 2a) shows three waves. The second peak was thankfully lower than the first; the third wave is already higher than the first in all areas except Seattle (King County). The non-Washington data (Figure 2b) is dominated by the early peak in Boston making it hard to see details later on, but the rates are heading up everywhere except Ann Arbor. Three weeks ago we saw a hint of a flattening in Boston, but it now seems that was wishful thinking.
...
In past, DOH updated the weekly data on Sundays, but as of December 22, 2020 they switched to Mondays. The release was a day late this week due to the Martin Luther King holiday on Monday.
