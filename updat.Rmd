...
The weekly downloads lag behind the daily feed causing data for the last few weeks to be incomplete (see [below](#extra) Figures 5a-b). In previous versions of this document I corrected for this undercount by extrapolating data from the preceding six weeks using a linear model (R's `lm`). Performance of the extrapolation became erratic in the most recent data, and I've turned it off in this version of the document.
