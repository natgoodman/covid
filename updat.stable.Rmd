...
The Washington data (Figure 2a) shows three waves. Last week it seemed that we had reached the peak of the third, but this week's data shows the death rate increasing. The second peak was thankfully lower than the first; the third peak is higher than the first in all areas except Seattle (King County). The non-Washington data (Figure 2b) is dominated by the early peak in Boston making it hard to see details later on, but the rates are heading up everywhere except Ann Arbor. Last week we saw a hint of a flattening in Boston, but it now seems that was wishful thinking. When comparing Figures 2a and 2b, please note the difference in y-scale: the current Washington rates (30-40 per million) are similar to the non-Washington rates.
...
7. I truncate the data to the last full week prior to the week reported here. Thus, data for the January 6 update includes counts through the last week of December and first few days of January, ending January 2.

8. I smooth the graphs using a smoothing spline (R's `smooth.spline`) for visual appeal. This is especially important for the *deaths* graphs where the counts are so low that unsmoothed week-to-week variation makes the graphs hard to read. In versions of the document prior to last week, I used a 3-week rolling mean for this purpose.
