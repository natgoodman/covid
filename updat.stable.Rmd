...
The graph for Washington (Figure 1a) show that rates, though well below their recent peaks, are climbing again in all locations. Rates in all locations have greatly exceeded their summer peaks. The increase statewide is about 50% and is  twofold or more for the individual counties. Going forward, we can only hope that vaccination of the most vulnerable people will prevent a large increase in deaths.

The picture for non-Washington locations (Figure 1b) is mixed. Cases are increasing rapidly in Ann Arbor and are now above the previous peak in November 2020. The rate in Boston has flattened after a brief climb, in San Diego the rate has flattened after a long, steep decline, and in Washington DC the rate continues a slow decline.

Figures 2a-b show *deaths* per million for the same locations. When comparing the Washington and non-Washington graphs, again please note the difference in y-scale: the current Washington rates are 5-10 per million; the non-Washington rates are 7-20 per million.
...
The Washington data (Figure 2a) shows three waves. The second peak was thankfully lower than the first; the third wave exceeded the first in all areas except Seattle (King County). The graphs are well down from the third peaks and finally below the first and second peaks but are flattening out.

The non-Washington data (Figure 2b) shows early peaks in most locations, followed by a long trough, followed by a second wave starting in November. The graphs are well down from their recent peaks. Deaths are continuing down in Boston, increasing in Ann Arbor, and flat in San Diego and Washington DC.
